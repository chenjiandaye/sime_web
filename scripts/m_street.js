...
if ((navigator.userAgent.match(
    ...
    // loadjscssfile('/templets/1/default/sime/styles/m_b2c.min.css', 'css')
    loadjscssfile('./styles/m_street.min.css', 'css')
} else { //电脑
    setTimeout(() => {
        $('body').removeClass('mobody')
    }, 0)
    // removejscssfile('/templets/1/default/sime/styles/m_b2c.min.css', 'css')
    removejscssfile('./styles/m_street.min.css', 'css')
}